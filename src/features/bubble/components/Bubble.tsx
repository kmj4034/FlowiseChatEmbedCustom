  ...
  return (
    <>
      ...
      <div
        part="bot"
        style={{
          height: bubbleProps.theme?.chatWindow?.height ? `${bubbleProps.theme?.chatWindow?.height.toString()}px` : 'calc(100% - 180px)',
        ...
        class={
          ...
          (props.theme?.button?.size === 'large' ? ' bottom-[154px]' : ' bottom-[150px]')
        }
      >
